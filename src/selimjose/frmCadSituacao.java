...
public class frmCadSituacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/LogoGSituacao.png"))); // NOI18N
        ...
        if ((!txtNomeSituacao.getText().isEmpty())) {
            ...
            if (aDao.Exists(a) != null) {
                ...
                try {
                    ...
                    Logger.getLogger(frmCadSituacao.class.getName()).log(Level.SEVERE, null, ex);
                }
